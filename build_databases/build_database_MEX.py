...
Get power plant data from Mexico and convert to Power Watch format.
...
for i in range(1,sheet.nrows):
    ...
    new_plant = pw.PowerPlant(plant_idnr=idnr,plant_name=name,plant_country=COUNTRY_NAME,
        ...
        plant_location=new_location,plant_coord_source=SOURCE_URL_1,
...
for i in range(1,sheet.nrows):
    ...
    new_plant = pw.PowerPlant(plant_idnr=idnr,plant_name=name,plant_country=COUNTRY_NAME,
        plant_owner=owner,plant_cap_year=data_date,
        plant_location=new_location,plant_coord_source=SOURCE_URL_2,
        plant_fuel=fuel,plant_capacity=capacity,
...
for i in range(2,sheet.nrows):
    ...
    new_plant = pw.PowerPlant(plant_idnr=idnr,plant_name=name,plant_country=COUNTRY_NAME,
        ...
        plant_location=new_location,plant_coord_source=SOURCE_URL_3,
        plant_fuel=fuel,plant_capacity=capacity,
