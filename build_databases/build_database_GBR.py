...
Get power plant data from UK and convert to Power Watch format.
...
RAW_FILE_NAME_REPD = pw.make_file_path(fileType = "raw", subFolder = SAVE_CODE_GBR, filename = "2016_12_December_-_Public_Database_-_Dec_2016.csv")
RAW_FILE_NAME_DUKES = pw.make_file_path(fileType = "raw", subFolder = SAVE_CODE_GBR, filename = "DUKES_5.10.xls")
CSV_FILE_NAME = pw.make_file_path(fileType = "src_csv", filename = "gbr_database.csv")
...
# REDP information
URL_REPD = "https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/583175/2016_12_December_-_Public_Database_-_Dec_2016.csv"
...
URL_DUKES = "https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/558040/DUKES_5.10.xls"
...
with open(RAW_FILE_NAME_REPD, "rU") as f:
    ...
    for row in datareader:
        ...
        plant_location=new_location, plant_coord_source = coord_source,
...
for i in range(first_data_row,sheet.nrows):
    ...
    if create_new_plant:
        ...
        new_plant = pw.PowerPlant(plant_idnr = plant_idnr, plant_name = name,
            ...
            plant_source = SOURCE_NAME, plant_source_url = SOURCE_URL,
            plant_location=location, plant_coord_source = coord_source,
            plant_fuel = fuel_type)
    plants_dictionary[plant_idnr] = new_plant
