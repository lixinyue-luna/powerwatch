...
SAVE_CODE = u"CARMA"
RAW_FILE_NAME = pw.make_file_path(fileType = "raw", subFolder = SAVE_CODE, filename = "Full_CARMA_2009_Dataset.json")
...
for plant in raw_plant_list:
    ...
    country = pw.standardize_country(plant['location']['country']['value'],country_thesaurus)
