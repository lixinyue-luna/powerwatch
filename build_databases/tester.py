...
f_log.write('Starting PowerWatch build run at {0}. DUMP_DATA: {1}\n'.format(time.ctime(),DUMP_DATA))

# print summary
print("Starting PowerWatch build; minimum plant size: {0} MW.".format(MINIMUM_CAPACITY_MW))
print("DUMP_DATA: {0}".format(DUMP_DATA))
...
for plant_id, plant in wri_database.iteritems():
	...
	# STEP 2.4: Write the rest plants into data dump
	plant.idnr = plant_id + u",No"
	powerwatch_datadump[plant_id] = plant
...
# STEP 5: Add unused CARMA plants
