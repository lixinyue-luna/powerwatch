...
Get power plant data from [country] and convert to Power Watch format.
Data Source: [Institution(s) providing these data sets]
Additional information: [URL]
Issues: [etc]

Notes:
- Unicode: All unicode conversion occurs in the powerwatch.py module function format_string().
...
with open(RAW_FILE_NAME,'rU') as f:
    ...
    for row in datareader:
        ...
        new_plant = pw.PowerPlant(plant_idnr=idnr,plant_name=name,plant_country=country,
            ...
            plant_source=SOURCE_NAME,source_url=SOURCE_URL)
