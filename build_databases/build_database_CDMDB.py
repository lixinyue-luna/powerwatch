...
Get power plant data from CDM and convert to Power Watch format.
...
CSV_FILE_NAME = pw.make_file_path(fileType = "src_csv", filename = "CDMDB-database.csv")
...
PROJECT_TYPES_TO_READ = ["Hydro", "Tidal", "Wind", "Solar", "Geothermal", "Biomass energy", 
                            "Mixed renewables"]
